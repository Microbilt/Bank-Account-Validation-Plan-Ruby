require 'net/http'
require 'json'
require_relative 'clients/ABAAcctVerificationClient'

module BankAccountValidationPlan
  class BankAccountValidationPlanClient
    attr_reader :authorization, :aba_acct_verification_client, :base_uri
    ...
    def initialize(client_id, client_secret, environment_type = EnvironmentType::Production)
      ...
      @aba_acct_verification_client = BankAccountValidationPlan::APIClients::ABAAcctVerificationClient.new(@authorization, @base_uri)
    end
